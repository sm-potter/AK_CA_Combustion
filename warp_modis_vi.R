...
raster_path <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions/ee/modis_VI'
out <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions_mosaiced/ee/modis_VI'
