...
bad_cols <- c('id', 'project.name', 'burn_year', 'latitude', 'longitude',
              ...
              'Wind.speed', 'VPD', 'stand.age', 'CNA_MAR')
...
above_stand <- model_compare(above, "/mnt/data1/boreal/spotter/combustion/final_files/model_comparisons/aboveground/stand_age/rfe_no_norm_no_all", 'above')
below_stand <- model_compare(below, "/mnt/data1/boreal/spotter/combustion/final_files/model_comparisons/belowground/stand_age/rfe_no_norm_no_all", 'below')
# 
