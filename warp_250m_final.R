...
raster_path <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions_mosaiced/ee/rest/250'
out <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions_warped/ee/rest/250'
dir.create(out, recursive = T)

years <- seq(2001, 2017, 1)

bands <- c('Sand_30', 'Silt_30', 'Clay_30', 'pH_30', 'SOC_30')
bands2 <- seq(1, 5, 1)

# for(band_n in bands2){
