...
raster_path <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions_mosaiced/ee/rest/500'
out <- '/mnt/data1/boreal/spotter/combustion/burned_area/final_predictions_warped/ee/rest/500'
