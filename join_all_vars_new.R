...
mod_native <- mod_native %>% dplyr::rename(CNA_Tmin_5_8 = CNA_Tmin_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_Tave_5_8 = CNA_Tave_sm)
mod_native<- mod_native %>% dplyr::rename(CNA_Rad_5_8 = CNA_Rad_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_DD_0_5_8 = CNA_DD_0_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_DD5_5_8 = CNA_DD5_sm)
mod_native<- mod_native %>% dplyr::rename(CNA_DD_18_5_8 = CNA_DD_18_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_NFFD_5_8 = CNA_NFFD_sm)
mod_native<- mod_native %>% dplyr::rename(CNA_PAS_5_8 = CNA_PAS_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_Eref_5_8 = CNA_Eref_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_CMD_5_8 = CNA_CMD_sm)
mod_native <- mod_native %>% dplyr::rename(CNA_RH_5_8 = CNA_RH_sm)
...
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_Tmin_5_8 = CNA_Tmin_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_Tave_5_8 = CNA_Tave_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_Rad_5_8 = CNA_Rad_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_DD_0_5_8 = CNA_DD_0_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_DD5_5_8 = CNA_DD5_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_DD_18_5_8 = CNA_DD_18_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_NFFD_5_8 = CNA_NFFD_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_PAS_5_8 = CNA_PAS_sm)
land_to_mod <- land_to_mod %>% dplyr::rename(CNA_Eref_5_8 = CNA_Eref_sm)
...
land_native <- land_native %>% dplyr::rename(CNA_Tmin_5_8 = CNA_Tmin_sm)
land_native <- land_native %>% dplyr::rename(CNA_Tave_5_8 = CNA_Tave_sm)
land_native <- land_native %>% dplyr::rename(CNA_Rad_5_8 = CNA_Rad_sm)
land_native <- land_native %>% dplyr::rename(CNA_DD_0_5_8 = CNA_DD_0_sm)
land_native <- land_native %>% dplyr::rename(CNA_DD5_5_8 = CNA_DD5_sm)
land_native <- land_native %>% dplyr::rename(CNA_DD_18_5_8 = CNA_DD_18_sm)
land_native <- land_native %>% dplyr::rename(CNA_NFFD_5_8 = CNA_NFFD_sm)
land_native <- land_native %>% dplyr::rename(CNA_PAS_5_8 = CNA_PAS_sm)
land_native <- land_native %>% dplyr::rename(CNA_Eref_5_8 = CNA_Eref_sm)
land_native <- land_native %>% dplyr::rename(CNA_CMD_5_8 = CNA_CMD_sm)
land_native <- land_native %>% dplyr::rename(CNA_RH_5_8 = CNA_RH_sm)
